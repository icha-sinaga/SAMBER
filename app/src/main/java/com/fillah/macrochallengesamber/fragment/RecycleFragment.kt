...
import com.fillah.macrochallengesamber.RecycleDetail
import kotlinx.android.synthetic.main.fragment_notification2.*
import kotlinx.android.synthetic.main.fragment_recycle2.*
...
class RecycleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn12.setOnClickListener {
            startActivity(Intent(this@RecycleFragment.activity, RecycleDetail::class.java))
        }
    }
}